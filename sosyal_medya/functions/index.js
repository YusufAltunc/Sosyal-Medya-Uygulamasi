...
/*
exports.kayitSilindi = functions.firestore
...
exports.kayitGuncellendi = functions.firestore
  .document("deneme/{docId}")
  .onUpdate((change, context) => {
    admin.firestore().collection("gunluk").add({
      aciklama: "Deneme koleksiyonunda kayıt guncellendi.",
    });
  });

exports.kayitGerceklesti = functions.firestore
  .document("deneme/{docId}")
  .onWrite((change, context) => {
    admin.firestore().collection("gunluk").add({
      aciklama:
        "Deneme koleksiyonunda veri ekleme, silme, güncelleme işlemlerinden biri gerçekleşti.",
    });
  });
*/
